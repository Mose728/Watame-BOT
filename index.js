...
*╟*๛ _Puede tardar hasta un minuto_
*╟ ❒ ${prefix}toimg*
...
query = args.join(" ")
const apis3l =['7c6c9a9e1138b473e6c64388','ff8508e71c332b870c1e8a1b','b57c69801b7b3e63b3b3e94c','e07d2ff8ff95d995809ec7b3','99ae3d189586081a2be37357','8cd8a7918eab2510afd496c0','69ca7c7a6206090978680cbe','9e91ba5f31f1eb7c772f3100','715bbe735bd7e25872ef40d6','5453dae015e205a91b6994ff']
const lolkeyapi = apis3l[Math.floor(Math.random() * apis3l.length)]
...
if (args.length < 1) return reply('Adjunta el enlace')
terr = args.join(" ")
const apis32 =['7c6c9a9e1138b473e6c64388','ff8508e71c332b870c1e8a1b','b57c69801b7b3e63b3b3e94c','e07d2ff8ff95d995809ec7b3','99ae3d189586081a2be37357','8cd8a7918eab2510afd496c0','69ca7c7a6206090978680cbe','9e91ba5f31f1eb7c772f3100','715bbe735bd7e25872ef40d6','5453dae015e205a91b6994ff']
...
const wnime =['Aquí tienes 💕🦈','¿Linda foto no?','Pedido entregado 🕊']
const wanim = wnime[Math.floor(Math.random() * wnime.length)]
cnf.sendMessage(from, il, image, { caption: wanim, quoted: mek })
await limitAdd(sender)                                     
addFilter(from)
break
